 ...
 */
class TypeClient extends \TypeClient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TypeClient' . "\0" . 'id', '' . "\0" . 'TypeClient' . "\0" . 'libelle', '' . "\0" . 'TypeClient' . "\0" . 'clientPhysiques'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeClient $proxy) {
