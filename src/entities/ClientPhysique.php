...
class ClientPhysique 
{
    ...
    */
    ...
    private $password;
    /**
     * @ManyToOne(targetEntity="TypeClient", inversedBy="clientPhysiques",cascade={"persist"})
     * @JoinColumn(name="idTypeClient", referencedColumnName="id")
     */
    private $typeClient;
    /**
     * @ManyToOne(targetEntity="ClientMoral", inversedBy="clientPhysiques",cascade={"persist"})
